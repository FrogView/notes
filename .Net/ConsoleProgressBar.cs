...
namespace Internal.Common
{
    ...
    /// 进度条类型
    /// </summary>
    public enum ConsoleProgressBarType
    {
        /// <summary>
        /// 字符
        /// </summary>
    ...
    public class ConsoleProgressBar
    {
        ...
        /// 进度条类型
        /// </summary>
        public ConsoleProgressBarType ProgressBarType { get; set; }
        ...
        public ConsoleProgressBar(int left, int top, int width = 50, ConsoleProgressBarType ProgressBarType = ConsoleProgressBarType.Multicolor)
        {
            this.Left = left;
            this.Top = top;
            this.Width = width;
            ...
            if (this.ProgressBarType == ConsoleProgressBarType.Multicolor)
            {
                // 绘制进度条背景； 
        ...
        public int Dispaly(int current, int max, string errmsg = null)
        {
            return Dispaly(Convert.ToInt32(((double)(current) / (max * 1.0)) * 100), errmsg);
        }

        private int Dispaly(int value, string msg)
        {
            if (this.Value != value)
            {
                this.Value = value;
